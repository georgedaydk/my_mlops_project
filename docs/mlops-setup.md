...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://data-science-dev.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://data-science-stage.cloud.databricks.com#setting/accounts). If
