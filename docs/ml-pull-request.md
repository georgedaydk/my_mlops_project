...
* [Staging model in UC](https://data-science-dev.cloud.databricks.com/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://data-science-stage.cloud.databricks.com/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
